...
///
/// The [init] method, which is called before the first listener is added. Code
/// which acquires resources or sets up listeners to other ValueCells/Listenables
/// should be located in this method.
///
/// The [dispose] method, which is called after the last listener is removed.
...
/// again after calling [dispose], if a new listener is added to the cell,
...
abstract class ManagedCell<T> extends ValueCell<T> {
  ...
  /// [Listenable]'s, or acquire resources it should be done in this method.
  ///
  ...
  /// [Listenable]'s, or acquired resources this method should be overridden
