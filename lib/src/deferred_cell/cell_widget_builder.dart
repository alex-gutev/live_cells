...
/// using [CellWidget.defer] and [CellWidget.mutableDefer] without having to
/// subclass [CellWidget] or [StatefulWidget].
class CellWidgetBuilder extends CellWidget {
  ...
  /// the [CellWidget.defer] and [CellWidget.mutableDefer] methods can be called.
  ///
