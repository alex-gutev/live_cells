...
description: Strategies for handling errors in two-way data flow
---
...
<CodeGroup title="Example of mutableString(errorValue: ...)">
```dart
...
<CodeGroup title="Numeric text field with error handling">
```dart
...
<CodeGroup title="Sum example using numberField()">
```dart
...
the content of the fields simply by changing the cells holding our
data.
